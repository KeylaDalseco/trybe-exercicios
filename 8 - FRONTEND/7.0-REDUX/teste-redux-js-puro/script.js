...
import { composeWithDevTools } from '@redux-devtools/extension'; // para a extensão funcionar
...
const store = createStore(reducer, composeWithDevTools()); // função para a extensão
