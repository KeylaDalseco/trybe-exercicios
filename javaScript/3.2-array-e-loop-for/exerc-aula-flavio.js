...
// 1- criar um algoritmo, criar um for;
// 2 - contar quantos numeros do intervalo entre 2 e 150 são divisíveis por 3;
// 3- caso seja igual a 50, faça um if;
// 4 - imprima uma mensagem secreta;
